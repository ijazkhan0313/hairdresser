    ...
    <header class="mt-3">
      <div class="row w-100">
        ...
        <div class="col-md-8 d-flex justify-content-center align-items-center header-image">
          <img src="/custom/img/header.png" alt="Hair Salon" height="80%" class="img-fluid">
        </div>
      </div>
    </header>
          ...
          <div class="xs:w-full xs:max-w-xs xs:mx-auto flex flex-col gap-4 md:flex-row">
            <div class="xs:max-w-xs xs:mx-auto relative flex justify-between gap-7 md:flex-col">
              ...
              <div v-for="index in totalSteps" :key="index"
                ...
                <span :class="['scale-0', { 'scale-1': index <= currentStep }]"
                  class="bg-primary-500 block size-2 rounded-full transition-transform duration-300"></span>
              </div>
            </div>
            <div class="relative flex justify-center gap-7 md:flex-col md:justify-between">
              <!-- Step Labels -->
              <a v-for="(label, index) in labels" :key="index" role="button" tabindex="0"
                class="cursor-default h-4 leading-none">
                <span
                  :class="{ 'text-muted-800 dark:text-muted-100': index + 1 === currentStep, 'text-muted-400 dark:text-muted-500': index + 1 !== currentStep }"
              ...
              <div class="relative max-w-md space-y-3">
                ...
                <div v-show="currentStep === 1">
                  ...
                  <div class="nui-input-wrapper nui-input-default nui-input-md nui-input-rounded-sm nui-has-icon">
                    ...
                    <div class="w-full space-y-4">
                      ...
                      <!-- Error message -->
                      <span v-if="showError" class="text-danger">Please select any service</span>
    

                      <!--Radio groups-->
                      <BaseRadioHeadless v-model="service" v-focus="service == 'Simple haircut for men'" value="Simple haircut for men" name="service"
                        class="nui-focus !appearance-none rounded-lg !opacity-100" required>
                        <div
                          ...
                          <div class="size-3 rounded-full bg-current transition-colors duration-300" />
                        </div>
                        <div
                          ...
                          <div class="border-muted-200 flex size-5 items-center justify-center rounded-full border" />
                      ...
                      <BaseRadioHeadless v-model="service" v-focus="service == 'Simple haircut for woman + Wash'" value="Simple haircut for woman + Wash" name="service"
                        class="nui-focus !appearance-none rounded-lg !opacity-100"  required>
                        <div
                          class="peer-checked:child:scale-1 peer-not-checked:child:scale-0 bg-muted-100 text-muted-100 dark:bg-muted-900 dark:text-muted-900 peer-checked:text-primary-500 absolute start-6 top-1/2 flex size-6 -translate-y-1/2 items-center justify-center rounded-full">
                          <div class="size-3 rounded-full bg-current transition-colors duration-300" />
                      ...
                      <BaseRadioHeadless v-model="service" v-focus="service == 'Simple haircut for woman'" value="Simple haircut for woman" name="service"
                        class="nui-focus !appearance-none rounded-lg !opacity-100"  required>
                        <div
                          class="peer-checked:child:scale-1 peer-not-checked:child:scale-0 bg-muted-100 text-muted-100 dark:bg-muted-900 dark:text-muted-900 peer-checked:text-primary-500 absolute start-6 top-1/2 flex size-6 -translate-y-1/2 items-center justify-center rounded-full">
                          <div class="size-3 rounded-full bg-current transition-colors duration-300" />
                ...
                <div v-show="currentStep === 2">
                  <div class="mb-8 space-y-2">
                   ...
                   <!-- Error message -->
                   <span v-if="showHairdresserError" class="text-danger">Please select any Hairdcutter</span>
                      ...
                      <TairoTableRow >
                        <TairoTableCell>
                          <div class="flex items-center ms-5 space-x-2">
                            <BaseRadio v-model="selectedHairdresser" :name="`hairdresser-${user.id}`" :value="user.id" />
                            <div class="flex items-center space-x-2">
                              <BaseAvatar src="https://tairo.cssninja.io/img/avatars/2.svg" size="sm" />
                 ...
                 <div class="col-span-12">
                  <TairoTable rounded="sm">
                    <TairoTableRow>
                      <TairoTableCell>
                        <div class="flex items-center ms-5 space-x-2">
                          <BaseRadio v-model="hairdresser" name="hairdresser" value="1" />
                          <div class="flex items-center space-x-2">
                            <BaseAvatar src="/custom/img/DSC_0006.JPG" size="sm" />
                            <div class="leading-none">
                              <h3 class="font-heading text-sm font-bold">
                               ijazkhan
                              </h3>
                  ...
                  <div class="col-span-12">
                    <TairoTable rounded="sm">
                      <TairoTableRow>
                        <TairoTableCell>
                          <div class="flex items-center ms-5 space-x-2"> <!-- Adjust spacing here -->
                            <BaseRadio v-model="hairdresser" name="hairdresser" value="2" />
                            <div class="flex items-center space-x-2"> <!-- Adjust spacing between image and text -->
                              <BaseAvatar src="https://tairo.cssninja.io/img/avatars/2.svg" size="sm" />
                              <div class="leading-none">
                                <h3 class="font-heading text-sm font-bold"> <!-- Bold text -->
                                  Lila Monroe
                                </h3>
                              </div>
                            </div>
                  ...
                  <div class="col-span-12">
                    <TairoTable rounded="sm">
                      <TairoTableRow>
                        <TairoTableCell>
                          <div class="flex items-center ms-5 space-x-2"> <!-- Adjust spacing here -->
                            <BaseRadio v-model="hairdresser" name="haircutter" value="3" />
                            <div class="flex items-center space-x-2"> <!-- Adjust spacing between image and text -->
                              <BaseAvatar src="https://tairo.cssninja.io/img/avatars/2.svg" size="sm" />
                              <div class="leading-none">
                                <h3 class="font-heading text-sm font-bold"> <!-- Bold text -->
                ...
                <div v-show="currentStep === 3">
                  <div class="mb-8 space-y-2">
                   ...
                   <!-- Error message -->
                   <span v-if="showDateError" class="text-danger">Please select Date</span>
                ...
                <div v-show="currentStep === 4">
                  <div class="mb-4 space-y-1"> <!-- Reduced margin-bottom and space between elements -->
                    <h2
                   ...
                   <!-- Error message -->
                   <span v-if="showTimeError" class="text-danger">Please select Time</span>
                  ...
                  <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="col-span-1">
                      <!-- Time Slot 1 -->
                      <TairoTable rounded="sm" class="!p-2"> <!-- Reduced padding in table -->
                        <TairoTableRow>
                          <TairoTableCell class="!py-2"> <!-- Reduced padding in table cell -->
                            <div class="flex items-center space-x-2 ms-3">
                              <BaseRadio v-model="time" name="time" value="09:00" class="!h-4 ms-3 !w-4" />
                              <!-- Reduced size of radio button -->
                              <Field name="meeting.frequency" class="text-sm">09:00</Field> <!-- Adjusted text size -->
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2 ms-3">
                              <BaseRadio v-model="time" name="time" value="09:30" class="!h-4 ms-3 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">09:30</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2 ms-3">
                              <BaseRadio v-model="time" name="time" value="10:00" class="!h-4 ms-3 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">10:00</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2 ms-3">
                              <BaseRadio v-model="time" name="time" value="10:30" class="!h-4 ms-3 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">10:30</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2 ms-3">
                              <BaseRadio v-model="time" name="time" value="11:00" class="!h-4 ms-3 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">11:00</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2"> <!-- Reduced padding in table -->
                        <TairoTableRow>
                          <TairoTableCell class="!py-2"> <!-- Reduced padding in table cell -->
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="11:30" class="!h-4 !w-4" />
                              <!-- Reduced size of radio button -->
                              <Field name="meeting.frequency" class="text-sm">11:30</Field> <!-- Adjusted text size -->
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                    ...
                    <div class="col-span-1">
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="12:00" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">12:00</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="12:30" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">12:30</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="13:00" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">13:00</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="13:30" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">13:30</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="14:00" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">14:00</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                      ...
                      <TairoTable rounded="sm" class="!p-2">
                        <TairoTableRow>
                          <TairoTableCell class="!py-2">
                            <div class="flex items-center space-x-2">
                              <BaseRadio v-model="time" name="time" value="14:00" class="!h-4 !w-4" />
                              <Field name="meeting.frequency" class="text-sm">14:30</Field>
                            </div>
                          </TairoTableCell>
                        </TairoTableRow>
                      </TairoTable>
                ...
                <div v-show="currentStep === 5" class="space-y-4">
                  <div class="mb-4 space-y-1"> <!-- Reduced margin-bottom and space between elements -->
                   ...
                   <!-- Error message -->
                   <span v-if="showContractError" class="text-danger">Please Add contact details</span>

                    <!-- Grid container for name inputs -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <!-- First Name Input -->
                      <BaseInput v-model="first_name" rounded="md" label="First Name" placeholder="First Name"
                        class="w-full" />
                      <!-- Last Name Input -->
                      <BaseInput v-model="last_name" rounded="md" label="Last Name" placeholder="Last Name"
                        class="w-full" />
                    </div>

                    <!-- Email Input -->
                    <BaseInput v-model="email" rounded="md" label="Email" placeholder="Email" class="w-full" />

                    <!-- Phone Input -->
                    <BaseInput v-model="phone" rounded="md" label="Phone" placeholder="Phone" class="w-full" />
                  </div>
                </div>
                ...
                <div v-show="currentStep === 6" class="space-y-4">
                  <div class="mb-4 space-y-1"> <!-- Reduced margin-bottom and space between elements -->
                    ...
                    <!-- Grid container for name inputs -->
                    <BaseRadioHeadless v-model="service" v-focus="service == '1'"  name="selected_service"
...
{{ selected_service_description }}
                    ...
                    <div class="col-span-12 mt-4">
                      <TairoTable rounded="sm">
                        <TairoTableRow>
                          <TairoTableCell>
                            <div class="flex items-center ms-4 space-x-2"> <!-- Adjust spacing here -->
                              <div class="flex items-center space-x-2"> <!-- Adjust spacing between image and text -->
                                <BaseAvatar src="https://tairo.cssninja.io/img/avatars/2.svg" size="sm" />
                                <div class="leading-none">
                                  <h3 class="font-heading text-sm font-bold"> <!-- Bold text -->
                      ...
                      <TairoTableRow>
                        <TairoTableCell class="!py-2"> <!-- Reduced padding in table cell -->
                          <div class="flex items-center space-x-2 ms-3">
                            ...
                            <!-- Reduced size of radio button -->
                            <Field name="selected_time" class="text-sm">{{selected_time}}</Field> <!-- Adjusted text size -->
                          </div>
                        </TairoTableCell>
                      </TairoTableRow>
                    </TairoTable>
                    ...
                    <TairoTable rounded="sm" class="!p-2"> <!-- Reduced padding in table -->
                      <TairoTableRow>
                        <TairoTableCell class="!py-2"> <!-- Reduced padding in table cell -->
                          <div class="flex flex-col space-y-2 ms-3"> <!-- Use flex-col to stack items vertically -->
                ...
                <div class="flex gap-2">
                  <button v-if="currentStep < totalSteps" type="button" @click="handleContinue"
            ...
            <div class="testimonial text-center">
              <div class="testimonial-text">
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <img src="https://static.vecteezy.com/system/resources/previews/024/354/252/non_2x/businessman-isolated-illustration-ai-generative-free-photo.jpg" alt="Person" class="rounded-circle"
          ...
          <div class="col-md-4 d-flex justify-content-center">
            <div class="testimonial text-center">
              <div class="testimonial-text">
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <img src="https://img.freepik.com/premium-photo/female-professional-hair-stylist-hair-dresser-hair-beauty-salon_1061358-4916.jpg" alt="Person" class="rounded-circle"
                    style="width: 50px; height: auto;">
                  <div class="ms-3">
          ...
          <div class="col-md-4 d-flex justify-content-center">
            <div class="testimonial text-center">
              <div class="testimonial-text">
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <img src="https://img.freepik.com/premium-photo/female-professional-hair-stylist-hair-dresser-hair-beauty-salon_1061358-4884.jpg" alt="Person" class="rounded-circle"
                    style="width: 50px; height: auto;">
                  <div class="ms-3">
...
const accordion = ref([
  {
    ...
    content:
      'Our Salon is open from 9:00 AM to 6:00 PM, Monday to Saturday',
  },
  {
    title: 'How do I book an appointment?',
    content:
      'You can book an appointment by filling the above form.',
  },
  {
    title: 'Do you offer hair styling for special occasions?', 
    content:
      'Yes, we provide expert hair styling services tailored for special occasions to ensure you look your best.',
  },
])
...
const labels = ['Services', 'Hair cutter', 'Date', 'Timeslot', 'Contact Information', 'Summary'];
...
function handleSubmit() {
  ...
  fetch('http://localhost:8000/api/v1/booking', {
    ...
    .then(data => {
      ...
      // Use setTimeout to ensure the user sees the notification before the page reloads
    setTimeout(() => {
      window.location.reload();
    }); // Adjust the delay as needed (2000 milliseconds = 2 seconds)
